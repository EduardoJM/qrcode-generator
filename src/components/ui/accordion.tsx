...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      ...
      className={cn(
        "not-last:border-b my-2 bg-primary text-primary-foreground rounded-lg shadow-lg p-4",
        className,
      )}
      {...props}
    />
